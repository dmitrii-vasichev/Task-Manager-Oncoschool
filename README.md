...
Рабочий портал команды ~20 человек с двумя точками входа: **Telegram-бот** и **веб-интерфейс**.

## Возможности

- **Задачи** — Telegram-бот + Kanban-доска, голосовое создание (Whisper STT + AI), AI-парсинг Zoom Summary
- **Встречи** — расписание, Zoom-интеграция, транскрипции, автоматическое создание задач
- **Отчёты** — интеграция с GetCourse, ежедневные KPI, графики и таблицы
- **Контент-анализ** — мониторинг Telegram-каналов с AI-анализом
- **Рассылки** — массовые уведомления через Telegram-бота
